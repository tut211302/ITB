...
class CustomModel(nn.Module):
    def __init__(self, model_name, label_numbers):
        ...
        if model_name == 'resnet18':
            ...
            self.base_model = models.resnext101_64x4d(weights=models.ResNeXt101_64X4D_Weights.DEFAULT)
            in_features_dim = self.base_model.fc.in_features
            self.base_model.fc = nn.Identity()
        elif model_name == 'wide_resnet50_2':
            self.base_model = models.wide_resnet50_2(weights=models.Wide_ResNet50_2_Weights.DEFAULT)
            in_features_dim = self.base_model.fc.in_features
            self.base_model.fc = nn.Identity()
        elif model_name == 'wide_resnet101_2':
            self.base_model = models.wide_resnet101_2(weights=models.Wide_ResNet101_2_Weights.DEFAULT)
            in_features_dim = self.base_model.fc.in_features
            self.base_model.fc = nn.Identity()
        ...
        # DenseNet系列
            ...
            self.base_model = models.densenet161(weights=models.DenseNet161_Weights.DEFAULT)
            in_features_dim = self.base_model.classifier.in_features
            self.base_model.classifier = nn.Identity()
        ...
        # VGG系列
            ...
            self.base_model = models.vgg11(weights=models.VGG11_Weights.DEFAULT)
            in_features_dim = self.base_model.classifier[6].in_features
            self.base_model.classifier[6] = nn.Identity()
        elif model_name == 'vgg11_bn':
            self.base_model = models.vgg11_bn(weights=models.VGG11_BN_Weights.DEFAULT)
            in_features_dim = self.base_model.classifier[6].in_features
            self.base_model.classifier[6] = nn.Identity()
        elif model_name == 'vgg13':
            self.base_model = models.vgg13(weights=models.VGG13_Weights.DEFAULT)
            in_features_dim = self.base_model.classifier[6].in_features
            self.base_model.classifier[6] = nn.Identity()
        elif model_name == 'vgg13_bn':
            self.base_model = models.vgg13_bn(weights=models.VGG13_BN_Weights.DEFAULT)
            in_features_dim = self.base_model.classifier[6].in_features
            self.base_model.classifier[6] = nn.Identity()
            ...
            self.base_model = models.vgg16_bn(weights=models.VGG16_BN_Weights.DEFAULT)
            in_features_dim = self.base_model.classifier[6].in_features
            self.base_model.classifier[6] = nn.Identity()
            ...
            self.base_model = models.vgg19_bn(weights=models.VGG19_BN_Weights.DEFAULT)
            in_features_dim = self.base_model.classifier[6].in_features
            self.base_model.classifier[6] = nn.Identity()
        ...
        # Inception系
            ...
            self.base_model = models.inception_v4(weights=models.Inception_V4_Weights.DEFAULT)
            in_features_dim = self.base_model.fc.in_features
            self.base_model.fc = nn.Identity()
        ...
        # EfficientNet系列
            ...
            self.base_model = models.efficientnet_b5(weights=models.EfficientNet_B5_Weights.DEFAULT)
            in_features_dim = self.base_model.classifier[1].in_features
            self.base_model.classifier[1] = nn.Identity()
        elif model_name == 'efficientnet_b6':
            self.base_model = models.efficientnet_b6(weights=models.EfficientNet_B6_Weights.DEFAULT)
            in_features_dim = self.base_model.classifier[1].in_features
            self.base_model.classifier[1] = nn.Identity()
            ...
            self.base_model = models.efficientnet_v2_m(weights=models.EfficientNet_V2_M_Weights.DEFAULT)
            in_features_dim = self.base_model.classifier[1].in_features
            self.base_model.classifier[1] = nn.Identity()
        elif model_name == 'efficientnet_v2_l':
            self.base_model = models.efficientnet_v2_l(weights=models.EfficientNet_V2_L_Weights.DEFAULT)
            in_features_dim = self.base_model.classifier[1].in_features
            self.base_model.classifier[1] = nn.Identity()

        # MobileNet系列
        elif model_name == 'mobilenet_v1':
            self.base_model = models.mobilenet_v1(weights=models.MobileNet_V1_Weights.DEFAULT)
            in_features_dim = self.base_model.classifier[1].in_features
            self.base_model.classifier[1] = nn.Identity()
        ...
        # Vision Transformer (ViT)
            ...
            self.base_model = models.vit_h_14(weights=models.ViT_H_14_Weights.DEFAULT)
            in_features_dim = self.base_model.heads.head.in_features
            self.base_model.heads.head = nn.Identity()
        ...
        # ConvNeXt系列
            ...
            self.base_model = models.xception(weights=models.Xception_Weights.DEFAULT)
            in_features_dim = self.base_model.fc.in_features
            self.base_model.fc = nn.Identity()
        elif model_name == 'mnasnet1_0':
            self.base_model = models.mnasnet1_0(weights=models.MNASNet1_0_Weights.DEFAULT)
            in_features_dim = self.base_model.classifier[1].in_features
            self.base_model.classifier[1] = nn.Identity()
        elif model_name == 'shufflenet_v2_x0_5':
            self.base_model = models.shufflenet_v2_x0_5(weights=models.ShuffleNet_V2_X0_5_Weights.DEFAULT)
            in_features_dim = self.base_model.fc.in_features
            self.base_model.fc = nn.Identity()
        elif model_name == 'shufflenet_v2_x1_0':
            self.base_model = models.shufflenet_v2_x1_0(weights=models.ShuffleNet_V2_X1_0_Weights.DEFAULT)
            in_features_dim = self.base_model.fc.in_features
            self.base_model.fc = nn.Identity()
        elif model_name == 'shufflenet_v2_x1_5':
            self.base_model = models.shufflenet_v2_x1_5(weights=models.ShuffleNet_V2_X1_5_Weights.DEFAULT)
            in_features_dim = self.base_model.fc.in_features
            self.base_model.fc = nn.Identity()
        elif model_name == 'shufflenet_v2_x2_0':
            self.base_model = models.shufflenet_v2_x2_0(weights=models.ShuffleNet_V2_X2_0_Weights.DEFAULT)
            in_features_dim = self.base_model.fc.in_features
            self.base_model.fc = nn.Identity()
